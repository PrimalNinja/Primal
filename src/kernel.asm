...
KERNEL:			jp Main			; kernel is a platform independent way to talk to the hardware

								; header
				dw RelocationTable - KERNEL
				dw 1			; version
...
SysKeyIn:		jp 0
SysISRInit:		jp 0
SysFuture3:		jp KERNEL_Future3

JUMPBLOCKLEVEL4:				; API Level 4

SysExecute6502:	jp Execute6502

JUMPBLOCKEND:
		
								; WARNING CODE BELOW HERE ONLY IN THIS FILE

KERNEL_Future3:	call SysError	; outputs a string pointed to by on the stack PC
				ret
		
KERNEL_Future4:	call SysError	; outputs a string pointed to by on the stack PC
				ret
