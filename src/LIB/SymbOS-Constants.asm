...
;@                                                                            @
;@             (c) 2000-2021 by Prodatron / SymbiosiS (Jörn Mika)             @
;@                                                                            @
;@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
MSC_DSK_STIUPD  equ 55  ;updates systray-icon (P1=number) ##not yet implemented##
...
MSR_DSK_MENCTX  equ 168 ;menu has been clicked or canceled (P1=1 ok, P2/3=value, P4=type [0=normal, 1=check])
MSR_DSK_STIADD  equ 169 ;result of adding systray-icon (P1=0 ok, P2=number)
MSR_DSK_EVTCLK  equ 170 ;defined event click (P1=event, P2=mouse key)
MSR_DSK_WMODAL  equ 171 ;user tried to click father-window of a modal window (P1=modal window number)
...
;Extended Desktop (used internally)
...
DSK_SRV_SCRCNV  equ 12  ;converts 4 colour graphics to 4/16 indexed graphics (input P2/3=table address, P4=banknumber)
DSK_SRV_DSKBIN  equ 13  ;initialize desktop background (no redraw)
...
FNC_FIL_STOOUT  equ 005 ;Storage WriteSector (Writes a sector to a mass storage device (no memory banking))
