...
RAM_SEL_PORT_APPHEAP_COUNT	equ 97
RAM_SEL_PORT_SYSHEAP_COUNT	equ 17
RAM_SEL_PORT_BUFFHEAP_COUNT	equ 17	; not supported in this model

RAM_BANK_START		equ #4000
RAM_BANK_END		equ #7FFF
RAM_BANK_SIZE		equ #4000

RAM_SEL_APP_PORTS:	defw #7cc4, #7cc5, #7cc6, #7cc7
ADDABLE_APP_PORTS:	defw #7ccc, #7ccd, #7cce, #7ccf
...
ADDABLE_SYS_PORTS:	defw #7fe4, #7fe5, #7fe6, #7fe7
...
ADDABLE_BUFF_PORTS:	defw #7fc4, #7fc5, #7fc6, #7fc7
